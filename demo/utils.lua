...
-- get the data cast on `cpu` or `gpu`
...
function utils.train(opt, model, dataset, logger)
    -- the OptimEngine contains all the optimization algorithms
    local engine = tnt.OptimEngine()
    -- the data format: dependents on the platform
    ...
    -- operation after all the training phase
